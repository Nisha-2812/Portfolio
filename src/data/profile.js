export const profile = {
  name: "Nisha Rani Barman",
  firstName: "Nisha",
  role: "UI/UX Designer & Data Analyst",
  tagline:
    "I design intuitive digital experiences and turn raw data into clear, actionable insights — blending clean UI/UX thinking with dashboards that tell a story.",
  ...
  about: [
    ...
    "On the analytics side, I work with Python, SQL, Power BI and Excel to clean, explore and visualize data, building dashboards that help teams make faster, evidence-based decisions.",
  ],
  aboutCards: [
    { label: "Education", value: "BTech CSE · SIT Siliguri" },
    { label: "CGPA", value: "7.6 · 7th Semester" },
    { label: "Focus", value: "UI/UX + Data Analytics" },
  ],
};
